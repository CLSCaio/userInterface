...
export default function Ciencia() {
  return (
      ...
      >
        ...
        <img src="https://t5z6q4c2.rocketcdn.me/wp-content/uploads/2020/04/o-que-e-ciencia-definicao-historia-tipos-de-ciencia-e-caracteristicas-2-1024x536.jpg" alt="Imagem não pode ser carregada" />
        <h1> Ciência </h1>
